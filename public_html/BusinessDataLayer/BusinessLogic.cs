...
namespace BusinessDataLayer
{
    public class BusinessLogic
    {
        ...
        public DataSet GetVideoDetailByAlbumId(DataAccessEntities SList)
        {
            ...
            try
            {
                dsTest = objDataAccessLogic.GetVideoDetailByAlbumId(SList);
                return dsTest;
            }
            catch (Exception ex)
            {
        ...
        public DataSet GetDoctorDetails(DataAccessEntities SList)
        {
            ...
            try
            {
                dsTest = objDataAccessLogic.GetDoctorDetails(SList);
                return dsTest;
            }
            catch (Exception ex)
            {
        ...
        public DataSet GetBannerPageContentDetail(DataAccessEntities SList)
        {
            ...
            try
            {
                ds = objDataAccessLogic.GetBannerPageContentDetail(SList);
                return ds;
            }
            catch (Exception ex)
            {
