                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                ...
                                <asp:RegularExpressionValidator Display="Dynamic" ID="RegularExpressionValidator3" runat="server" ErrorMessage="Please Enter Valid Email ID" ValidationGroup="QuickEnqSubmit" ControlToValidate="txtEmail" CssClass="requiredFieldValidateStyle"
...
<%--                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" Display="Dynamic" runat="server" ControlToValidate="txtCaptcha" ValidationGroup="QuickEnqSubmit" ForeColor="Red" ErrorMessage="Please Enter above text"></asp:RequiredFieldValidator>

                                <asp:CustomValidator ID="CustomValidator1" Display="Dynamic" ErrorMessage="Invalid. Please try again." ValidationGroup="QuickEnqSubmit" OnServerValidate="ValidateCaptcha"
                                    runat="server" />
                            </div>
                        </div>--%>
