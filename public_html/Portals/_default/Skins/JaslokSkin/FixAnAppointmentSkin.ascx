                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9 col-xs-8">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvNm" CssClass="errormsg" ControlToValidate="txtName" runat="server" ForeColor="Red" ValidationGroup="FAP" Display="Dynamic" ErrorMessage="Please Enter Name"></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="revnm" runat="server" CssClass="errormsg" ControlToValidate="txtName" ValidationExpression="[a-zA-Z' ']+" ForeColor="Red" Display="Dynamic" ValidationGroup="FAP" ErrorMessage="Please Enter only alphabate"></asp:RegularExpressionValidator>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9 col-xs-8">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvEmail" runat="server" Display="Dynamic" ControlToValidate="txtEmail" CssClass="errormsg" ValidationGroup="FAP" ForeColor="Red" ErrorMessage="Please Enter Email ID"></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" Display="Dynamic" runat="server" CssClass="errormsg" ErrorMessage="Please Enter Valid Email ID" ValidationGroup="vgSubmit" ControlToValidate="txtEmail"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9 col-xs-8">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" CssClass="errormsg" ControlToValidate="txtMobileNo" runat="server" ForeColor="Red" ValidationGroup="FAP" ErrorMessage="Please Enter Mobile Number" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" CssClass="errormsg" runat="server" ControlToValidate="txtMobileNo" ErrorMessage="Enter 10 digit number" ValidationGroup="FAP" ValidationExpression="[0-9]{10}" Display="Dynamic"></asp:RegularExpressionValidator>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9 col-xs-8">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvDrpUsertype" CssClass="errormsg" runat="server" ErrorMessage="Please select Country" ControlToValidate="ddlCountry" InitialValue="0"
                                        ValidationGroup="FAP" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9 col-xs-8">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" CssClass="errormsg" ControlToValidate="txtState" runat="server" ForeColor="Red" ValidationGroup="FAP" ErrorMessage="Please Enter state" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" CssClass="errormsg" ControlToValidate="txtState" ValidationExpression="[a-zA-Z' ']+" ValidationGroup="FAP" ForeColor="Red" ErrorMessage="Please Enter only alphabate" Display="Dynamic"></asp:RegularExpressionValidator>

                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-xs-3" for="lblFixDoctor">Doctor:</label>
                                <div class="col-xs-12 col-sm-9 col-xs-8">
                            ...
                            <telerik:RadAjaxPanel ID="RadSearchPanel" LoadingPanelID="RadAjaxLoadingPanel1" runat="server" RestoreOriginalRenderDelegate="false">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3 col-xs-3" for="drpSpecialty">Appointment Day:</label>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3 col-xs-3" for="drpSpecialty">Appointment Date:</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9 col-xs-8">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" CssClass="errormsg" ControlToValidate="txtInquiry" runat="server" ForeColor="Red" ErrorMessage="Please Enter Inquiry" ValidationGroup="FAP" Display="Dynamic"></asp:RequiredFieldValidator>
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-offset-3 col-xs-9">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" ControlToValidate="txtCaptcha" runat="server" ForeColor="Red" ErrorMessage="Please Enter above code" Display="Dynamic" ValidationGroup="FAP"></asp:RequiredFieldValidator>

                                                <asp:CustomValidator ID="CustomValidator2" Display="Dynamic" ErrorMessage="Invalid. Please try again." ValidationGroup="FAP" ControlToValidate="txtCaptcha" OnServerValidate="ValidateCaptcha" runat="server" ForeColor="Red" />
                            ...
                            <div class="form-group" style="text-align:center;">
                                <div class="col-xs-offset-0 col-sm-offset-3 col-xs-12 ">
                                    ...
                                    <asp:LinkButton ID="btnPayNow" runat="server" class="btn btn-primary" OnClick="btnPayNow_Click" ValidationGroup="FAP" Visible="false">Pay Now</asp:LinkButton>
