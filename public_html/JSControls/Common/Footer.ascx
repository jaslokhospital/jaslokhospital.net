                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 foot">
                        <div class="hidden-xs">
                          ...
                          <JS:Subscription runat="server" ID="Subscription1" />
                               <a href="/jasloktimes">
                            <h4 style="color:#ffffff">Jaslok Time Archives:</h4></a>
                        </div>
                        ...
                        <div class="hidden-lg hidden-md hidden-sm visible-xs">
                            <div class="socialdiv colored">
                                <ul>
                                    ...
                                    <li><a class="" href="http://facebook.com/jaslokhospital" target="_blank"><img src="/images/fb.png" alt="facebook" title="facebook" class="img-responsive" /></a></li>
                                    <li><a class="" href="http://www.youtube.com/jaslokhospitalindia" target="_blank"><img src="/images/yu.png" alt="youtube" title="youtube" class="img-responsive" /></a></li>
                                    <li><a class="" href="https://www.linkedin.com/company/jaslok-hospital" target="_blank"><img src="/images/li.png" alt="linked-in" title="linked-in" class="img-responsive" /></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
