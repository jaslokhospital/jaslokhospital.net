...
<asp:Repeater ID="rptInnerTrustees" runat="server">
    <ItemTemplate>
        ...
        <div class='<%#Container.ItemIndex==0?"media trustees-accordion":"media" %>'>
            <div class='<%#Container.ItemIndex+1%2==0?"media-left media-top col-sm-3 col-xs-12":"media-left col-sm-3 col-xs-12 mgt-main-space" %>' style="padding:0;">
                <a data-toggle="collapse" data-parent="#accordion" href="#media-collapse-1" aria-expanded="true" aria-controls="media-collapse-1">
                    <img class="media-object media-border img-responsive profile-bg" src='<%#Eval("ImageUrl")%>' width="150">
                </a>
            </div>
            <div class="media-body col-sm-9 col-xs-12 mgt-main-info" style="padding:0;">
