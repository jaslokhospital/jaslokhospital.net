<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BookAppointment.ascx.cs"
    Inherits="JSControls_Home_BookAppointment" EnableViewState="true" ViewStateMode="Enabled" %>
        ...
        <div class="container">
            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                <div class="book-now" style="text-align: center;">
                    <asp:PlaceHolder ID="plcBookNowPracto" runat="server" Visible="false">
                        <div class="text">
                            To book an appointment with our specialist click Book Now</div>
                        ...
                        <a id="qikwell-widget-container" data-widget-id="e990c7ef-f1c0-4036-8b49-720f77d31fbd"
                            data-sub-source="1" name="qikwell-widget-container" data-entity-type="clinic"
                            data-entity-id="c78e8bf6-78ba-4e5b-87dc-e4efd5079ac9">Book Appointment at Jaslok
                            Hospital and Research Centre,Peddar Road,Mumbai</a>
                    </asp:PlaceHolder>
                    <div style="display: block;">
                        <div class="bookappointmentie">
                            <asp:DropDownList CssClass="sort-by col-md-3" runat="server" ID="ddlSpecialtyB" OnSelectedIndexChanged="ddlSpecialtyB_SelectedIndexChanged"
                                AutoPostBack="true" EnableViewState="true" ViewStateMode="Enabled">
                            </asp:DropDownList>
                        </div>
                        <div class="bookappointmentie">
                            <asp:DropDownList class="sort-by col-md-3" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlDoctor_SelectedIndexChanged"
                                ID="ddlDoctor">
                            </asp:DropDownList>
                        </div>
                        <div class="bookappointmentie">
                        ...
                        <asp:Button ID="tbnHBAppointment" runat="server" Text="BOOK NOW" class="btn col-md-1"
                            OnClick="tbnHBAppointment_Click" ValidationGroup="grpBAdoctor" />
                        <div class="bookappointmentie">
                            <asp:RequiredFieldValidator ID="refDoctor" runat="server" class="col-md-2" ControlToValidate="ddlDoctor"
                                Font-Size="15px" ToolTip="Please select doctor" ErrorMessage="Please select doctor"
                                ForeColor="red" InitialValue="0" ValidationGroup="grpBAdoctor"></asp:RequiredFieldValidator>
                        </div>
...
<telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel1" runat="server" Transparency="30">
    <div class="modal-dialog" style="vertical-align: middle; text-align: center; background-color: white;
        margin-top: 0px !important; height: 100%; width: 100%;">
