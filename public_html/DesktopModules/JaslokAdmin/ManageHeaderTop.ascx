...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <asp:GridView ID="gvContent" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" ShowFooter="true" Style="margin-left: 50px" Width="1049px" OnRowCancelingEdit="gvContent_RowCancelingEdit"
        ...
        <Columns>
            <asp:TemplateField HeaderText="Key" HeaderStyle-Width="30%">
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Value" HeaderStyle-Width="35%">
                <EditItemTemplate>
             ...
             <asp:TemplateField HeaderText="Alias" HeaderStyle-Width="15%">               
                <ItemTemplate>
            ...
            <asp:CommandField ShowEditButton="true" ShowHeader="true" HeaderText="Action" CausesValidation="false"/>
