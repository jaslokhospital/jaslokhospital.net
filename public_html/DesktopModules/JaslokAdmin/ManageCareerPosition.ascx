...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="form-horizontal">
        <asp:PlaceHolder ID="plcAdd" runat="server" Visible="false">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <asp:CheckBox ID="ckbIsApproved" runat="server" Width="100%" Height="34px" Font-Size="14px" />
        ...
        <asp:PlaceHolder ID="plcView" runat="server">
            ...
            <br />
            <asp:Button ID="btnAddPosition" runat="server" Text="Add Career Positions" CssClass="btn btn-default" OnClick="btnAddPosition_Click" /><br />
            <br />
