...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="form-horizontal">
        <asp:PlaceHolder ID="plcAdd" runat="server" Visible="false">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <asp:RequiredFieldValidator ID="rfvName" runat="server" ErrorMessage="Please Enter Name" ControlToValidate="txtName"
                        Display="Dynamic" ValidationGroup="MD" ForeColor="Red"></asp:RequiredFieldValidator>
                ...
                <div class="col-md-4">
                    ...
                    <asp:RequiredFieldValidator ID="rfvEmail" runat="server" Display="Dynamic" ControlToValidate="txtEmail" ForeColor="Red" ValidationGroup="MD" ErrorMessage="Please Enter Email ID"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" Display="Dynamic" ErrorMessage="Please Enter Valid Email ID" ValidationGroup="MD" ControlToValidate="txtEmail"
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <asp:RequiredFieldValidator ID="rfvmob" ControlToValidate="txtMob" runat="server" ForeColor="Red" Display="Dynamic" MaxLength="10" ValidationGroup="MD" ErrorMessage="Please Enter Mobile Number"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="rgvMob" MinimumValue="1000000000" Type="Double" MaximumValue="9999999999" Display="Dynamic" ControlToValidate="txtMob" runat="server" ForeColor="Red" ValidationGroup="MD" ErrorMessage="Please Enter valid Mobile Number"></asp:RangeValidator>
                ...
                <div class="col-md-4">
                    ...
                    <%--  <asp:RangeValidator ID="rgvPhoneNumber" runat="server" ControlToValidate="txtPhn" Type="Double" ForeColor="Red" MinimumValue="0" ErrorMessage="Please enter valid phone number" ValidationGroup="MD"></asp:RangeValidator> 
                    --%>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <asp:RegularExpressionValidator ID="rexp" runat="server" ControlToValidate="UploadImages" ForeColor="Red" ValidationGroup="MD" ErrorMessage="Only .gif, .jpg, .png, .tiff and .jpeg"
            ...
            <div class="row">
                <div class="col-md-6">
                    <label for="redPageContent">Consulting Charge:<span style="color: red">*</span></label>
                    <asp:TextBox ID="txtConsultingCharge" runat="server" CssClass="form-control" MaxLength="5"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Enter ConsultingCharge" ControlToValidate="txtConsultingCharge"
                        Display="Dynamic" ValidationGroup="MD" ForeColor="Red"></asp:RequiredFieldValidator>
                </div>
                <div class="col-md-6">
                    <label for="redPageContent">Followup Charge:<span style="color: red">*</span></label>
                    <asp:TextBox ID="txtFollowupCharge" runat="server" CssClass="form-control" MaxLength="5"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please Enter Followup Charge" ControlToValidate="txtFollowupCharge"
                        Display="Dynamic" ValidationGroup="MD" ForeColor="Red"></asp:RequiredFieldValidator>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: center;">
                    <asp:Button ID="btnSubmit" runat="server" Text="Save" ValidationGroup="MD" OnClick="btnSubmit_Click" class="btn btn-primary2" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:PlaceHolder ID="plcView" runat="server">
            ...
            <div class="form-group">
                <asp:Button ID="btnAddDoctor" runat="server" Text="Add Doctor" CssClass="btn btn-default" OnClick="btnAddJaslokTimes_Click" /><br />
                <br />

                <div class="row" style="text-align: center;">
                    <div class="col-md-10">
                        <asp:TextBox ID="txtSearchDoctor" CssClass="form-control" runat="server" Style="float: left;"></asp:TextBox></div>
                    <div class="col-md-2" style="text-align: left;">
                        <asp:Button ID="btnSearch" runat="server" Text="Search Doctor" OnClick="btnSearch_Click" CssClass="btn btn-default" /></div>
                </div>
                <br />
