<%@ control inherits="Cross.Modules.Admin.FileManager.UserFileManager, App_Web_userfilemanager.ascx.6c70b780" language="vb" autoeventwireup="false" explicit="True" %>
		...
		<td valign="top" colspan="3">
			<table class="FileManager_ToolBar" cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr>
					...
					<td class="NormalTextBox" style="vertical-align:middle; width:1px"><asp:DropDownList ID="ddlStorageLocation" runat="server" Visible="false" /></td>
					<td class="Normal" style="vertical-align:middle; width:140px" ><asp:textbox id="txtNewFolder" Runat="server" EnableViewState="False"   Width="140px"/></td>
					...
					<td class="Normal" style="vertical-align:middle; width:120px">
						<span id="return" runat="server">
    					  <asp:LinkButton  ID="cmdReturn" OnClick="cmdReturn_Click"
...
<%--<asp:panel id="pnlSecurity" Runat="server" Visible="False" HorizontalAlign="Left">
    ...
    <dnn:sectionhead id="secUpload" runat="server" resourcekey="secUpload" cssclass="Head" section="tblUpload"/>
    <table class="normal" cellspacing="0" cellpadding="0" width="100%" align="center" id="tblUpload"
        border="0" runat="server">
                    ...
                    <tr>
                        <td align="top" colspan="3">
                            ...
                            <dnn:CommandButton ID="cmdUpload" runat="server" CssClass="CommandButton" imageurl="~/images/save.gif" ResourceKey="cmdUpload" />&nbsp;&nbsp;
                            <asp:CheckBox ID="chkUnzip" runat="server" CssClass="Normal" TextAlign="Right" resourcekey="Decompress" />
                        </td>
                    </tr>
                    <tr  >
                        <td align="top" colspan="3">
                            <asp:DropDownList ID="ddlFolders" runat="server" Width="650px">
                           
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td align="top" colspan="3"><asp:Label ID="lblMessage" runat="server" CssClass="Normal" Width="500px" EnableViewState="False" /></td>
                    </tr>
                </table>
