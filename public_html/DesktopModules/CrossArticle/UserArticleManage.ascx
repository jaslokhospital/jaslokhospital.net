<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UserArticleManage.ascx.cs"
    Inherits="Cross.Modules.Article.View.UserArticleManage" %>
...
<%@ Register TagPrefix="cross" TagName="UserFile" Src="~/DesktopModules/CrossArticle/controls/UserFileControl.ascx" %>
...
<table width="100%" class="Normal" align="center" runat="server" id="tblButton">
    <tr valign="top">
        <td align="center">
             <asp:Image ImageUrl="~/images/add.gif" runat="server" ID="imgAdd" />
            <asp:LinkButton CssClass="CommandButton" ID="lbtnAdd" OnClick="lbtnAdd_Click" resourcekey="lbtnAdd"
                runat="server" BorderStyle="none"  CausesValidation="False"></asp:LinkButton>&nbsp;&nbsp;
          <asp:Image ImageUrl="~/images/save.gif" runat="server" ID="imgUpdateReturn" Visible="false" /><asp:LinkButton
             ...
             <asp:Image ImageUrl="~/DesktopModules/CrossArticle/images/SaveContinue.gif" runat="server"
                ID="imgUpdateContinue" Visible="false" /><asp:LinkButton CssClass="CommandButton"
                    ID="lbtnUpdateContinue" resourcekey="lbtnUpdateContinue" runat="server" BorderStyle="none"
                    Text="Update And Continue" Visible="false" OnClick="lbtnUpdateContinue_Click"></asp:LinkButton>&nbsp;&nbsp;
...
<table width="100%" class="Normal" align="center" runat="server" id="tblList">
    <tr id="trSearch" runat="server" visible="true">
        <td>
            ...
            <br />
            <asp:DropDownList ID="ddlCategory" runat="server" Width="220px" CssClass="NormalTextBox"
                                ...
                                <asp:TemplateField HeaderImageUrl="~/images/register.gif" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgEditArticle" runat="server" CausesValidation="False" CommandName="Select"
                                          ...
                                          <asp:ImageButton ID="imgCopyAsNew" runat="server" CausesValidation="False" CommandName="Copy" CommandArgument='<%# Eval("Id")%>'
                                            AlternateText='<%#Localization.GetString("imgCopyAsNew", LocalResourceFile)%>' ImageUrl="~/images/icon_tabs_16px.gif"  ToolTip='<%#Localization.GetString("imgCopyAsNew", LocalResourceFile)%>'/>
                                        <asp:ImageButton ID="imgToggleAuthed" runat="server" CausesValidation="False" CommandName="Auth" Visible='<%#HasManagePermission%>'
                                       ...
                                       <asp:ImageButton ID="imgToggleDraft" runat="server" CausesValidation="False" CommandName="Draft"
                                        ...
                                        <asp:ImageButton ID="imgToggleFeatured" runat="server" CausesValidation="False" CommandName="Featured" Visible='<%#HasManagePermission%>'
    ...
    <tr visible="false" runat="server" id="trDetail">
        <td align="left" valign="top" colspan="2">
                    ...
                    <td valign="top" colspan="2">
                      <dnn:SectionHead ID="secBasic" CssClass="SubHead" runat="server" Section="tblBasic"
                        ...
                        <table id="tblBasic" cellspacing="0" cellpadding="2" width="100%" border="0" runat="server">
                            ...
                            <tr id="trArticleStatus" valign="top" runat="server">
                                <td class="Normal" style="width:150">
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    <dnn:URL ID="ctlImage" runat="server" ShowTabs="False" ShowUrls="false" UrlType="F" ShowUpLoad="true"
                                        FileFilter="jpg,jpeg,jpe,gif,bmp,png" Width="350" ShowTrack="False"
                                        ShowLog="False" Required="False">
                                    </dnn:URL>
                                      <cross:UserFile ID="ctlUserImage" runat="server" FileFilter="jpg,jpeg,jpe,gif,bmp,png" ShowUpLoad="true"
                        ...
                        <table id="tblAttachment" cellspacing="0" cellpadding="2" width="100%" border="0"
                            ...
                            <tr id="Tr2" runat="server">
                                ...
                                <td id="Td3" valign="middle" runat="server">
                                    <dnn:URL runat="server" ID="ctlAttachment" ShowDatabase="false" ShowLog="false" ShowNewWindow="false"
                                        ShowSecure="False" ShowTabs="false" Width="400" ShowTrack="false" ShowUrls="false" ShowUpLoad="true"
                                        ShowUsers="false" />
                                     <cross:UserFile ID="ctlUserAttachment" runat="server" ShowUpLoad="true"
          ...
          <asp:Image ImageUrl="~/images/save.gif" runat="server" ID="imgUpdateReturn1" Visible="false" /><asp:LinkButton
                ...
                Visible="false"></asp:LinkButton>&nbsp;&nbsp;
             <asp:Image ImageUrl="~/DesktopModules/CrossArticle/images/SaveContinue.gif" runat="server"
                ID="imgUpdateContinue1" Visible="false" /><asp:LinkButton CssClass="CommandButton"
                    ID="lbtnUpdateContinue1" resourcekey="lbtnUpdateContinue" runat="server" BorderStyle="none"
                    Text="Update And Continue" Visible="false" OnClick="lbtnUpdateContinue_Click"></asp:LinkButton>&nbsp;&nbsp;
